      ...
      <footer className="border-t border-stroke bg-white dark:border-strokedark dark:bg-blacksection">
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
              ...
              >
                <a href="/" className="relative">
                  <Image
                    width={250}
                    height={110}
                    src="/images/hosting/logo-tst.png"
                    alt="Logo"
                    className="mb-8 dark:hidden"
                  />
                </a>

                <p className="mb-3 text-sectiontitle font-semibold uppercase tracking-[5px] text-orange-500">
                  contact:
                </p>
                <a
                  href="#"
                  className="  text-itemtitle font-medium text-blue-600 "
                >
                  Torang@info.com
                </a>
              </motion.div>
                ...
                >
                  ...
                  <ul>
                    <li>
                      <a
                        href="#"
                        className="mb-3 inline-block hover:text-orange-600"
                      >
                        Home
                      </a>
                    </li>
          ...
          <div className="flex flex-col flex-wrap items-center justify-center gap-5 border-t border-stroke py-7 dark:border-strokedark lg:flex-row lg:justify-between lg:gap-0">
            ...
            >
              <p>
                &copy; {new Date().getFullYear()} Torang. All rights reserved
              </p>
            </motion.div>
              ...
              <ul className="flex items-center gap-5">
                <li>
                  <a href="#" aria-label="social icon">
                    <svg
                      className="fill-[#D1D8E0] transition-all duration-300 hover:text-orange-600"
                      width="24"
                      height="24"
                      viewBox="0 0 24 24"
                      fill="none"
