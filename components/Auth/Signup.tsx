          ...
          >
            ...
            <div className="flex items-center gap-8">
              <button
                ...
                className="text-body-color dark:text-body-color-dark dark:shadow-two mb-10 flex w-full items-center justify-center rounded-md border border-stroke bg-[#f8f8f8] px-6 py-3 text-base outline-none transition-all duration-300 hover:border-primary hover:bg-primary/5 hover:text-primary dark:border-transparent dark:bg-[#2C303B] dark:hover:border-primary dark:hover:bg-primary/5 dark:hover:text-primary dark:hover:shadow-none"
              >
                <span className="mr-3">
                  <svg
                    width="20"
            ...
            <div className="mb-10 flex items-start justify-start font-bold ">
              <p className="text-body-color w-full  items-start justify-start text-start text-base">
            ...
            <form>
              ...
              <div className="flex flex-wrap gap-10 md:justify-between xl:gap-15">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2.5 rounded-full bg-orange-500 px-6 py-3 font-medium text-white duration-300 ease-in-out hover:bg-blackho dark:bg-btndark dark:hover:bg-blackho"
                >
                  Create Account
                  <svg
